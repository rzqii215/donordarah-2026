<div>
    ...
    <header class="auth-heading">
        <p class="auth-kicker">Selamat datang kembali</p>
        <h2>Masuk ke akun Anda</h2>
        <p>Kelola aktivitas donor dan pengajuan darah melalui akun yang telah terdaftar.</p>
    </header>
    ...
    <a
        ...
        @if (! $googleRouteAda) aria-disabled="true" @endif
    >
    ...
    <form wire:submit="authenticate" class="auth-form" novalidate>
        ...
        <label class="auth-field" x-data="{ tampil: false }">
            ...
            <span class="auth-control @error('password') auth-control--error @enderror">
                ...
                <button
                    ...
                    x-bind:aria-label="tampil ? 'Sembunyikan password' : 'Tampilkan password'"
                >
                    <svg x-show="! tampil" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                        <path d="M2.5 12s3.5-6 9.5-6 9.5 6 9.5 6-3.5 6-9.5 6-9.5-6-9.5-6Z"/>
                        <circle cx="12" cy="12" r="2.5"/>
                    </svg>
                    <svg x-cloak x-show="tampil" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
                        <path d="m3 3 18 18M10.6 6.2c.5-.1.9-.2 1.4-.2 6 0 9.5 6 9.5 6a16 16 0 0 1-2.2 2.8M6.2 6.2A15.6 15.6 0 0 0 2.5 12s3.5 6 9.5 6c1.6 0 3-.4 4.2-1"/>
                    </svg>
                </button>
            </span>
        ...
        <div class="auth-options">
            ...
            <a href="{{ url('/forgot-password') }}" class="auth-text-link">
                Lupa password?
            </a>
        </div>
    ...
    <section class="auth-register-links">
        ...
        <div class="auth-register-actions">
            <a href="{{ url('/register/donor') }}" class="auth-button auth-button--primary">
                Daftar Pendonor
            </a>
            <a href="{{ url('/register/pemohon-donor') }}" class="auth-button auth-button--secondary">
                Daftar Pemohon
            </a>
        </div>
    </section>
